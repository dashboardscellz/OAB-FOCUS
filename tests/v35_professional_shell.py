...
def test_assets_loaded_after_v34():
    ...
    assert 'href="data/v35-shell.css?v=36.2"' in h
    assert 'src="data/v35-shell.js?v=36.2"' in h
    assert 'src="data/v35-auth.js?v=36.2"' in h
    assert h.index('src="data/v35-shell.js?v=36.2"') > h.index('data/v34-patch.js')
...
def test_v35_versioned_assets_avoid_stale_github_pages_shell_cache():
    h=INDEX.read_text(encoding='utf-8')
    for asset in ['data/v35-shell.css?v=36.2','data/v35-auth.js?v=36.2','data/v35-shell.js?v=36.2']:
        assert asset in h

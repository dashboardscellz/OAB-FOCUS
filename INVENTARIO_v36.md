...
- `index.html` — carregamento dos assets v36, cache `?v=36.2` e marcador da versão.
...
Os testes que verificavam exclusivamente a chave de cache `?v=35.9` foram atualizados para `?v=36.2`. As demais asserções funcionais foram preservadas.

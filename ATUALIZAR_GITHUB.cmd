...
echo ==============================================
echo   OAB FOCUS v36.1 - PREPARACAO PRINCIPAL 1a FASE
echo ==============================================
echo.
echo Origem: %SRC%
echo Destino: %DST%
...
if not exist "%SRC%index.html" (
  ...
  echo Extraia o ZIP inteiro e execute este .cmd de dentro da pasta v36.1.
  pause
  exit /b 2
)

if not exist "%SRC%data\integral-material.js" (
  echo ERRO: a pasta data da v36.1 nao foi encontrada.
  pause
  exit /b 3
)
...
if not exist "%SRC%data\v35-content-coverage.js" (
  echo ERRO: a cobertura pedagogica da v36.1 nao foi encontrada.
  pause
  exit /b 4
)
...
echo OK: v36.1 copiada e arquivos essenciais validados.
echo.
echo ==============================================
echo COPIA CONCLUIDA.
echo Agora abra o GitHub Desktop:
echo 1. Confira a aba Changes.
echo 2. Summary: OAB Focus v36.1 - acabamento editorial e ferramenta principal 1a fase

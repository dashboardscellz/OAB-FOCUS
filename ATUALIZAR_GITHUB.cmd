...
echo ==============================================
echo   OAB FOCUS v19 - ATUALIZACAO DO REPOSITORIO
echo ==============================================
echo.
echo Origem: %SRC%
echo Destino: %DST%
...
if not exist "%SRC%index.html" (
  ...
  echo Extraia o ZIP inteiro e execute este .cmd de dentro da pasta v19.
  pause
  exit /b 2
)

if not exist "%SRC%data\integral-material.js" (
  echo ERRO: a pasta data da v19 nao foi encontrada.
  pause
  exit /b 3
)

if not exist "%SRC%data\v19-patch.js" (
  echo ERRO: o patch principal da v19 nao foi encontrado.
  pause
  exit /b 4
)
...
if not exist "%DST%\data\v19-patch.js" goto :verify_error
...
echo OK: v19 copiada e arquivos essenciais validados.
echo.
echo ==============================================
echo COPIA CONCLUIDA.
echo Agora abra o GitHub Desktop:
echo 1. Confira a aba Changes.
echo 2. Summary: OAB Focus v19 - consolidacao visual

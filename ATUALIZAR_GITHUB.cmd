...
echo ==============================================
echo   OAB FOCUS v15 - ATUALIZACAO DO REPOSITORIO
echo ==============================================
echo.
echo Origem: %SRC%
echo Destino: %DST%
...
if not exist "%SRC%index.html" (
  ...
  echo Extraia o ZIP inteiro e execute este .cmd de dentro da pasta v15.
  pause
  exit /b 2
)

if not exist "%SRC%data\integral-material.js" (
  echo ERRO: a pasta data da v15 nao foi encontrada.
  pause
  exit /b 3
)
...
rem A v15 removeu os mapas. Apaga apenas os diretórios antigos conhecidos do site.
...
echo OK: v15 copiada, dados validados e mapas antigos removidos.
echo.
echo ==============================================
echo COPIA CONCLUIDA.
echo Agora abra o GitHub Desktop:
echo 1. Confira a aba Changes.
echo 2. Summary: OAB Focus v15 - caminho diario e vinculo de questoes
